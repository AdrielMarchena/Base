...
namespace render
{
	...
	QuadRender2D Render2D::m_QuadRender;
	CircleRender Render2D::m_CircleRender;
	LineRender2D Render2D::m_LineRender;
	QuadRender2D Render2D::m_TextRender;
	TriRender Render2D::m_TriRender;
	...
	{
		m_QuadRender	= QuadRender2D(quad_vs, quad_fs);
		m_LineRender	= LineRender2D(line_vs, line_fs);
		m_CircleRender	= CircleRender(circle_vs, circle_fs);
		m_TextRender	= QuadRender2D(text_vs, text_fs);
		m_TriRender		= TriRender(tri_vs, tri_fs);
