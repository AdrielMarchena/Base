...
TARGETDIR = yaml-cpp/bin/Debug-linux-x86_64/yaml-cpp
TARGET = $(TARGETDIR)/libyaml-cpp.a
OBJDIR = yaml-cpp/bin-int/Debug-linux-x86_64/yaml-cpp
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -fPIC -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -fPIC -g -std=c++17
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64

else ifeq ($(config),debug_x86)
TARGETDIR = yaml-cpp/bin/Debug-linux-x86/yaml-cpp
TARGET = $(TARGETDIR)/libyaml-cpp.a
OBJDIR = yaml-cpp/bin-int/Debug-linux-x86/yaml-cpp
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m32 -fPIC -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m32 -fPIC -g -std=c++17
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -m32

else ifeq ($(config),release_x64)
TARGETDIR = yaml-cpp/bin/Release-linux-x86_64/yaml-cpp
TARGET = $(TARGETDIR)/libyaml-cpp.a
OBJDIR = yaml-cpp/bin-int/Release-linux-x86_64/yaml-cpp
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -fPIC
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -fPIC -std=c++17
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -s

else ifeq ($(config),release_x86)
TARGETDIR = yaml-cpp/bin/Release-linux-x86/yaml-cpp
TARGET = $(TARGETDIR)/libyaml-cpp.a
OBJDIR = yaml-cpp/bin-int/Release-linux-x86/yaml-cpp
...
TARGETDIR = yaml-cpp/bin/Dist-linux-x86_64/yaml-cpp
TARGET = $(TARGETDIR)/libyaml-cpp.a
OBJDIR = yaml-cpp/bin-int/Dist-linux-x86_64/yaml-cpp
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -fPIC -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -fPIC -g -std=c++17
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64

else ifeq ($(config),dist_x86)
TARGETDIR = yaml-cpp/bin/Dist-linux-x86/yaml-cpp
TARGET = $(TARGETDIR)/libyaml-cpp.a
OBJDIR = yaml-cpp/bin-int/Dist-linux-x86/yaml-cpp
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m32 -fPIC -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m32 -fPIC -g -std=c++17
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -m32
